						...
						<ul>
							<li data-transition="fade">
								...
								<div class="tp-caption top-label"
									...
									data-start="500"
									style="z-index: 5"
									data-transform_in="y:[-300%];opacity:0;s:500;">21 CSS Solutions</div>
								...
								<div class="tp-caption main-label"
									...
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;">OUR SOLUTIONS</div>
								...
								<div class="tp-caption bottom-label"
									...
									data-start="2000"
									style="z-index: 5"
									data-transform_in="y:[100%];opacity:0;s:500;">Always make your business efficient and productive</div>
							...
							<li data-transition="fade">
								...
								<div class="tp-caption top-label"
									...
									data-start="500"
									style="z-index: 5"
									data-transform_in="y:[-300%];opacity:0;s:500;">21 CSS Data Services</div>
								...
								<div class="tp-caption main-label"
									...
									data-transform_out="opacity:0;s:500;"
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;">Our Data Expertise</div>
								...
								<div class="tp-caption bottom-label"
									...
									data-start="2000"
									style="z-index: 5"
									data-transform_in="y:[100%];opacity:0;s:500;">Reaching new heights in data integrity</div>
